...
impl Renderer {
    ...
    pub fn render(
        ...
        // Render pass
        {
            ...
            // Select pipeline based on wireframe and backface culling settings
            let pipeline = match (wireframe, backface_culling) {
                (true, true) => &self.wireframe_pipeline_culled,
                (true, false) => &self.wireframe_pipeline,
                (false, true) => &self.solid_pipeline_culled,
                (false, false) => &self.solid_pipeline,
            };

            render_pass.set_pipeline(pipeline);
            // Use triangle indices for both solid and wireframe (PolygonMode::Line draws triangles as lines)
