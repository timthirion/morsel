//! Isotropic remeshing algorithms.
//!
//! This module provides algorithms for remeshing triangle meshes to achieve
//! uniform, near-equilateral triangles with a target edge length.
//!
//! # Algorithm
//!
