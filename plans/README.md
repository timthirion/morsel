...
Living planning documents for **morsel**, versioned in the repo so work can move
between machines — or between agent sessions — without losing state.

## Why these live in the repo

A plan is the hand-off: anyone — human or agent — picking the repo up later should
be able to read the active plan and continue without reconstructing context. Keep
plans current as you work; a ticked checkbox here is the source of truth for
"what's done." Commit plan updates alongside the code they describe.
...
## Design
The approach. Struct sketches, algorithm shapes, trade-offs considered.
...
## Done when
The acceptance criteria — green tests, a measured number, a landed command.
```
...
- Claims about behaviour belong next to a number that was actually measured.
